...
data %>% 
  ggplot(aes(x = fico, y = days.with.cr.line, color = dti)) +
  geom_point() +
  geom_smooth(method = "loess")

data %>% 
  ggplot(aes(x = dti, y = fico, color = log.annual.inc)) +
  geom_point() +
...
lm(fico ~  days.with.cr.line*dti*log.annual.inc - days.with.cr.line:log.annual.inc, data = data) %>% summary()
```
```{r}
